            ...
            <Layout className="pt-16">
                ...
                <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
                    <div className="col-span-3 flex flex-col items-start justify-start dark:text-light xl:col-span-4 md:order-2 md:col-span-8">
                        ...
                        <p className="font-medium">Hi, {`I'm`} CodeBucks, a web developer and UI/UX designer with a passion for creating beautiful, functional, and user-centered digital experiences. With 4 years of experience in the field. I am always looking for new and innovative ways to bring my {`client's`} visions to life.</p>
                    ...
                    <div className="col-span-3 relative h-max rounded-2xl border-2 border-sloid border-dark bg-light p-8 dark:bg-dark dark:border-light xl:col-span-4 md:order-1 md:col-span-8">
                    ...
                    <div className="col-span-2 flex flex-col items-end justify-between dark:text-light xl:col-span-8 xl:flex-row md:order-3">
                        <div className='flex flex-col items-end justify-center xl:items-center'>
                            <span className='text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl'><AnimateNumber value="40"/>+</span>
                        ...
                        <div className='flex flex-col items-end justify-center xl:items-center'>
                            <span className='text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl'><AnimateNumber value="50"/>+</span>
                        ...
                        <div className='flex flex-col items-end justify-center xl:items-center'>
                            <span className='text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl'><AnimateNumber value="8"/>+</span>
